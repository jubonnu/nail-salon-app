<template>
    <div class="min-h-screen">
        <header
            ...
            class="bg-white shadow-sm py-2 px-2 sm:px-4 fixed top-0 left-0 right-0 z-20"
        >
            <div class="container mx-auto flex justify-between items-center">
                <div class="flex items-center">
                    <NuxtLink to="/admin/dashboard" class="flex items-center">
                        ...
                        />
                        <span
                            class="ml-2 text-base sm:text-lg font-semibold text-primary"
                            >NailPro</span
                        >
                    </NuxtLink>
                </div>
            ...
            <div class="flex min-h-screen">
                ...
                >
                    <nav class="p-4 relative">
                        ...
                        <div class="mb-8">
                            <p
                                class="text-xs uppercase text-gray-400 mb-2 clear-both"
                                :class="{
                ...
                <!-- モバイル用ナビゲーションバー -->
                <div
                    class="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-up z-10"
                >
